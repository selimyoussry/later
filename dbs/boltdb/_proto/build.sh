...
# Python
$WORKON_HOME/grpc/bin/python -m grpc_tools.protoc -I=. -I=$GOPATH/src/ --python_out=. --grpc_python_out=. ./bolt.proto

# Go
protoc -I=. -I=$GOPATH/src/ ./bolt.proto --go_out=plugins=grpc:$GOPATH/src
go install
